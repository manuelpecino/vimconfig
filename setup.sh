...
# Añadido clangd a la lista
sudo apt update && sudo apt install -y curl vim nodejs npm clang clangd clang-format shellcheck shfmt python3-pip python3-venv black flake8
